    ...
    var body: some View {
        ...
        VStack{
            ...
            HStack{
                ...
                Image("pazzle4_missyonn")
                //Text("x: \(location3.x)y: \(location3.y)")
            }
            ...
            HStack{
                ...
                if (-55)...(-40) ~= location3.x && (-322)...(-304) ~= location3.y &&
                    (115)...(136) ~= location2.x && (-237)...(-205) ~= location2.y &&
                    (-100)...(-78) ~= location6.x && (-411)...(-390) ~= location6.y
                {
                    Button("正解判定") {
                        pianoState = 0
                        ShowSeikaiView = 1
...
struct Pazzle4_cont_Previews: PreviewProvider {
